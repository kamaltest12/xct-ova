...
vault_attrs = {
    ...
    'universal_execution_callback': {'credential': environment.get('Vault', 'universal_execution_callback_password')},
    'universal_execution': {'credential': environment.get('Vault', 'universal_execution_password')}
