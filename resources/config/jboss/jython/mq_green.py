...
from queue_list import green_queues
from queue_list import green_qcf_names
...
# Delete QCFs
deleted_qcf = False
for qcf_name in green_qcf_names:  # TODO: find out why we have this lower-case name
...
qcf_attrs = {
    'use-ccm': 'true',
    'jndi-name': 'java\\:jboss\\/jms\\/GREENQCF',
...
cli.add('./connection-definitions=greenqcf', qcf_attrs)
cli.cd('./connection-definitions=greenqcf')
...
for qcf_name in green_qcf_names:
    cli.cd('/subsystem=naming')
